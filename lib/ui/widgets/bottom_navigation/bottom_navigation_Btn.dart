// ignore_for_file: deprecated_member_use_from_same_package, file_names
        ...
        child: Column(
          children: [
            read.state.index == index
                ? selectedIcon.svg(color: Theme.of(context).primaryColor)
                : unselectedIcon.svg(color: Theme.of(context).primaryColor),
            const SizedBox(
              height: 6,
            ),
            title != null
